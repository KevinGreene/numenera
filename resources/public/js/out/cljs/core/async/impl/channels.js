...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13928 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13928 = (function (val,box,meta13929){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13928.cljs$lang$type = true;
cljs.core.async.impl.channels.t13928.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13928";
cljs.core.async.impl.channels.t13928.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t13928");
});
cljs.core.async.impl.channels.t13928.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13928.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13930){var self__ = this;
var _13930__$1 = this;return self__.meta13929;
});
cljs.core.async.impl.channels.t13928.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13930,meta13929__$1){var self__ = this;
var _13930__$1 = this;return (new cljs.core.async.impl.channels.t13928(self__.val,self__.box,meta13929__$1));
});
cljs.core.async.impl.channels.__GT_t13928 = (function __GT_t13928(val__$1,box__$1,meta13929){return (new cljs.core.async.impl.channels.t13928(val__$1,box__$1,meta13929));
});
}
return (new cljs.core.async.impl.channels.t13928(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13931 = self__.takes.pop();if((taker_13931 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13931))
{var take_cb_13932 = cljs.core.async.impl.protocols.commit.call(null,taker_13931);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13932,taker_13931){
return (function (){return take_cb_13932.call(null,null);
});})(take_cb_13932,taker_13931))
);
} else
{}
{
