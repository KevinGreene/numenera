...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13922 = 0;while(true){
var m_13923 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13923 == null))
{} else
{m_13923.call(null);
if((count_13922 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13924 = (count_13922 + 1);
count_13922 = G__13924;
continue;
}
} else
{}
