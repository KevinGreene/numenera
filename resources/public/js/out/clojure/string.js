...
{{
var G__10854 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10854;
continue;
}
} else
...
{var pred__10858 = cljs.core._EQ_;var expr__10859 = limit;if(cljs.core.truth_(pred__10858.call(null,1,expr__10859)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10858.call(null,2,expr__10859)))
...
var G__10861 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10862 = (limit__$1 - 1);
var G__10863 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10861;
limit__$1 = G__10862;
parts = G__10863;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10865 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10865))
{var replacement_10866 = temp__4090__auto___10865;buffer.append([cljs.core.str(replacement_10866)].join(''));
} else
{buffer.append(ch);
}
{
var G__10867 = (index + 1);
index = G__10867;
continue;
}
}
