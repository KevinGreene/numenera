...
{return (function() { 
var G__11194__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__11197 = o;(G__11197[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__11197;
}),{},x);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__11198){var vec__11200 = p__11198;var id = cljs.core.nth.call(null,vec__11200,0,null);var class$ = cljs.core.nth.call(null,vec__11200,1,null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_11201 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_11201 === "key")))
{(o[pname_11201] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__11204 = jsprops;(G__11204["defaultValue"] = value);
(G__11204["value"] = null);
(G__11204["onChange"] = (function (p1__11202_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11202_SHARP_);
}));
return G__11204;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__11206 = spec;(G__11206["componentDidUpdate"] = (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
}));
(G__11206["componentWillUnmount"] = (function (){var c = this;return reagent.impl.batching.dispose.call(null,c);
}));
return G__11206;
});
...
return (function (p1__11207_SHARP_,p2__11208_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__11207_SHARP_,p2__11208_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__11210 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__11210,0,null);var id = cljs.core.nth.call(null,vec__11210,1,null);var class$ = cljs.core.nth.call(null,vec__11210,2,null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__11212 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__11212,0,null);var id_class = cljs.core.nth.call(null,vec__11212,1,null);return reagent.impl.template.wrap_component.call(null,comp,id_class,[cljs.core.str(tag)].join(''));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,0));var jsprops = {"level": level, "argv": v};var k_11213 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__11214 = (((k_11213 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,1,null)):k_11213);if((k_SINGLEQUOTE__11214 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__11214);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + 1);var n__4250__auto___11215 = a.length;var i_11216 = 0;while(true){
if((i_11216 < n__4250__auto___11215))
{(a[i_11216] = reagent.impl.template.as_component.call(null,(a[i_11216]),level_SINGLEQUOTE_));
{
var G__11217 = (i_11216 + 1);
i_11216 = G__11217;
continue;
}
} else
